...
public class AnimalGUI extends JFrame implements ActionListener {
     ...
     */
    private final JButton removeFirstButton = new JButton("Remove First");
    /**
     ...
     */
    private final JButton removeLastButton = new JButton("Remove Last");

    private LinkedOrderedList<Animals> animalList = new LinkedOrderedList<Animals>();
    ...
    public void actionPerformed(ActionEvent ev) {
        ...
        if (object == addReptileButton) {//if buttom clicks the reptile button
        ...
        } else if (object == removeLastButton) {//if buttom clicks remove button

            try {
                animalList.removeLast();//dequeue the animal from the queue
        ...
        } else if (object == removeFirstButton) {//if buttom clicks the next button
            ...
            verifyArea.append(animalList.toString());//display all animals in queue
        }
    }
